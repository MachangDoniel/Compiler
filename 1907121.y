...
%error-verbose
%token START INT CHAR STRING FLOAT DOUBLE SWITCH CASE DEFAULT SWAP COMBINATION PERMUTATION POW RANDOM SCAN IF ELIF ELSE WHILE SIN NSIN COS NCOS TAN NTAN LOG2 LOG10 FACTOR PRIME OUTPUT FOR TO INC DEC MAX MIN ID NUM PLUS MINUS MULTI DIVI EQUALS NOTEQUAL GT GTE LT LTE 
%left PLUS MINUS
%left MULTI DIVI
